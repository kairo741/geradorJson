...
class AppColors {
  ...
  static final Color grey2 = Color.fromARGB(154, 115, 115, 115);
  static final Color lightGrey = Color.fromARGB(255, 206, 206, 206);
  ...
  //Yellow
  static final Color yellow = Color(0xFFFDD835);
